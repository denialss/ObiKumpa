    ...
    <section class="blog-details spad mt-5">
        <div class="container">
            <div class="row d-flex justify-content-center">
                <div class="col-lg-10">
                    <div class="blog__details__title">
                        <h2 style="font-size: 40px;">SR3 Hino RM280 by ASXFM</h2>
                            <img src="<?php echo base_url('assets/user/img/sr3rm2803.jpg');?>" alt="">
                            <div class="blog__details__item__text"><br><br>
                            <p class="text-left">In Japan the idea of a first-year speaking to a senior the way Kageyama did to Asahi is a
                ...
                <div class="col-lg-8">
                    <div class="blog__details__content">
                        ...
                        <h4 class="text-center" style="font-size: 30px;">Sreenshot</h4>

                            <img src="<?php echo base_url('assets/user/img/sr3rm2802.jpg');?>" alt="">
                            <img src="<?php echo base_url('assets/user/img/sr3rm2801.jpg');?>" alt="">
                            ...
                            <iframe width="750" height="480" src="https://www.youtube.com/embed/nlsqVwSB_-A?si=yaMkOPWuf9m6Zrqi" title="YouTube video player" frameborder="0" 
